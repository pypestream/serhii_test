...
//             cloudinary.uploader
//               .upload(filepath, { use_filename: true })
//               .then((result) => {
//                 console.log(
//                   "%cresult------------------->",
//                   "color: green; font-size: larger; font-weight: bold",
...
//         res.resume();
//         const redirectUrl = res.rawHeaders.find((item) =>
...
//   name: "remote-image",
//   file: "image.png",
//   url: "https://github.com/pypestream/serhii_test/assets/103273897/6374261a-c677-4f4d-a412-849bc7e8d6f4",
// };
